...
さらに、LINE通知機能でお風呂の時間をお知らせし、決まった時間に習慣づけるお手伝いをします。
...
その後このアプリの構想を友人たちに話した際には、「作ってほしい」「それを使いたい」「改善するきっかけにしたい」という声が上がりました。こうした意見を通じて少なくとも私の周りでは、お風呂に関する悩みを共有できる場やサポートを求める人が少なくはないことを実感しています。
...
スクールに入りプログラミング学習を始めた際、エンジニアは絶え間ない技術革新や情報の変化に対応するため、日々の学習を継続する必要があると実感しました。しかし、学習を習慣化することは長年学習をすることから離れていた私にとって大きな課題でした。また、スクールのカリキュラムが間に合うのか、プログラミング学習が難しく躓くことも多々ありましたので、学習に対する不安も多くありました

スクールのグループワークで、「学習習慣を定着させる」という目標に取り組んだ際、帰宅後という毎日ある程度の時間を決めること、スクール内のコミュニティに参加しそれををプログラミング学習の行動のトリガーとすること、そして同じ目標に向かう仲間と励まし合うことで、学習を継続することができました。また交流がない日でも、アルバイトから帰宅後に自然とPCに向かい、学習に取り組むという行動を習慣的かつ機械的に行えるようになりました。また実際取り掛かかってみると、学習に対する不安も少し紛れました。このように機械的に行動できるようになることで、心理的な負担が軽減されると感じました。

この経験を通じ、同じ目標を持った仲間と励まし合う大切さと同時に、「いつの間にかやっている」という感覚を実現することで、心理的負担を和らげ、スムーズに行動を起こすことができると確信しました。この仕組みをお風呂の習慣化に応用することで、お風呂の工程の多さによる疲労感を軽減することができると考えています。

# ■ ユーザー層について
## お風呂を後回しにしがちで、その状況を打破したい人<br>
...
さらに、毎日決まった時間に届くLINEリマインド機能で、同じ時間にお風呂に入るリズムを整え、習慣化をサポートさせていただきます。同時にお気に入りのピン止め投稿も確認することができます。<br>
...
毎日届くLINEリマインド機能で、決まった時間にお風呂に入るリズムを作り、習慣化のサポートを致します。お気に入りのピン止め投稿も同時に確認できます。<br>
...
この機能により、
ユーザーが投稿一覧の中から知りたい工程の時短方法や役立つ情報を
ピンポイントで見つけられることが狙いです。
...
- メールアドレス変更<br>
新しいメールアドレスに変更したい場合などにご利用いただけます。

- LINEリマインド設定<br>
LINE連携が確認できたら、通知のオンオフ、
毎日のお風呂のリマインド時間を設定可能です。
これにより、同じ時間にお風呂へ向かえるよう、
習慣化サポートをさせていただきます。
...
まずコミュニティ系SNSとしてX（旧Twitter）やInstagram、mixi2など、またリマインダー機能としてはGoogleカレンダーやMicrosoft To Do、iPhone標準内蔵のリマインダーといったサービスが広く利用されています。またこれら2種類のツールを組み合わせれば、本アプリと似た体験を得ることは可能です。(お風呂周りに特化したものだと、入浴することで自律神経を整える健康管理サポートアプリ「onsen」が存在します。)

本アプリは「お風呂に関する悩みや工夫を共有できるコミュニティ」と「お風呂の時間をお知らせするリマインダー機能」を一つのアプリケーションで統合している点で差別化を狙います。投稿・投稿閲覧機能から始めて少しずつ記録を重ねたり、工夫の情報収集をし、実践している内容をシェアできるアプローチはこのサービスの大きな特長です。さらに皆が日常的に使い慣れているLINEを活用し、リマインダー通知に加え、ピン留めした投稿を一緒に送ることで、工夫を実践するためのサポートをします。またユーザーは自分に合った使い方やペースを選べるため、コミュニティを通して情報交換をしリマインダー機能によって習慣化を目指す方だけでなく、情報交換のみしたい方や、単に同じ悩みを持ったコミュニティに参加したい方も無理なく利用できます。さらにリマインドの通知を一時的にオフにしお風呂の工程の見直しや、習慣化の再構築を行うことができる点で、ユーザーの生活ペースに最大限寄り添えるような工夫をしております。
...
- マイページ
    - ユーザーネーム・アイコン画像変更
- 新規投稿
    - タイトル、本文、画像、カテゴリ、タグ、を投稿可能
- 投稿一覧
    - 投稿したユーザーのアイコンと名前、タイトル本文(文字数は制限)、画像、タグ(3つまで)
- カテゴリ絞り込み
- タグ・キーワード検索
- 投稿詳細
    - 投稿したユーザーのアイコンと名前、タイトル、本文、画像、カテゴリ、タグ、投稿した日時
- 投稿編集 / 削除
- コメント編集/消去
...
- TOPページ(やり方)
- マイページ
    - 設定(LINEリマインド連携・リマインドオンオフ、リマインド時間設定、メールアドレス変更、退会)
    - マイ投稿一覧
- 新規投稿
